Rails.application.configure do
  ...
  # config.active_job.queue_name_prefix = "book-buddy_#{Rails.env}"

  # Devise default URL configurations
  config.action_mailer.default_url_options = { host: 'localhost', port: 3000 } # Change to real URL when ready to go live
